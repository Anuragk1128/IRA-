...
export const products: Product[] = [
  ...
  {
    id: "2",
    name: "Snail shaped Hoop",
    description:
      "Classic Gold Cresent earrings with brilliant cuts. Timeless elegance that complements any outfit.",
    price: 1499,
    images: [ "/Polished Gold Crescent Earrings.png"],
    category: "earrings",
    subcategory: "studs",
    material: "Metal",
    color: "Gold",
